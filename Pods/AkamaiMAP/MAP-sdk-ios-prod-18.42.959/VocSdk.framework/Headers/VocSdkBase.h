...
/*!
   ...
   @constant VOCItemMetadataNotReceived Item has been created locally. Waiting for metadata update from Server. If metadata update was not successful, the reason for failure can be found in VocItem::downloadError.
...
/*!
   ...
   @constant VOCErrDownloadLaterLimit Items queued for download later has reached the maximum limit set in VocConfig::maxLaterDownloads.
